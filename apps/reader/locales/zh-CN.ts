export default {
  ...
  'settings.preset.reasoning': '思考强度',
  'settings.preset.reasoning.default': '默认（跟随模型）',
  'settings.preset.reasoning.off': '关闭思考',
  'settings.preset.reasoning_hint': '思考模型（DeepSeek V4 / GPT-5 系等）适用；模型不支持该参数时会翻译失败，改回默认即可',
