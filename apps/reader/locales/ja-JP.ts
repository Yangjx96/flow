export default {
  ...
  'settings.preset.reasoning': '思考の強さ',
  'settings.preset.reasoning.default': 'デフォルト（モデル任せ）',
  'settings.preset.reasoning.off': '思考なし',
  'settings.preset.reasoning_hint': '思考モデル（DeepSeek V4 / GPT-5 系など）向け。モデルが未対応の場合は翻訳が失敗するので、デフォルトに戻してください',
