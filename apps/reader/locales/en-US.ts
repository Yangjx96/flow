export default {
  ...
  'home.upload': 'Upload',
  'home.delete': 'Delete',
  'home.remove_local': 'Remove local',
  ...
  'settings.preset.reasoning': 'Reasoning effort',
  'settings.preset.reasoning.default': 'Default (model decides)',
  'settings.preset.reasoning.off': 'No thinking',
  'settings.preset.reasoning_hint': 'For reasoning models (DeepSeek V4, GPT-5 family…); if the model rejects the parameter, translation fails — switch back to Default',
  ...
  'settings.sync.status.off': 'Not authorized for this account — data stays on this device.',
  'settings.sync.status.unknown': 'Checking…',
  'settings.sync.status.disabled': 'Disabled — data stays on this device.',
  'settings.data': 'Data',
